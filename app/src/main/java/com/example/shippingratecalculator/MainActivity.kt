...
//    val itemPrices = Array (3){i -> 5 - i}
    val itemPrices = Array(3) {5 - it}
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        add_button.setOnClickListener {
            addItem(name_text.text.toString(),weight_number.text.toString())
            showItem()
        }

        discount_checkbox.setOnCheckedChangeListener { compoundButton, b ->
            couponApplied = b
            showItem()
        }
